...
| ------------------               | ---------------                | -------------                                  | --------------                              | -------------                      | ----------------     |
| 2.2. Economic Parameters         | txFeePerByte                   | TFPB-01 (y) <br> TFPB-02 (y) <br> TFPB-03 (y)  | must not be lower than 30 (0.000030 ada)                     | must not exceed 1,000 (0.001 ada)                                   | must not be negative                     |
